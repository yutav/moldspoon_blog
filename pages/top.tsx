    ...
    <Layout>
      <div className="mt-2 md:mt-8 
       ...
       w-full lg:w-full grid grid-cols-4 lg:gap-x-16 gap-y-16 justify-items-center">
        ...
        <CategoryBox url={"/tags/%E5%88%9D%E7%B4%9A%E8%80%85"} imageUrl={process.env.baseUrl + "/assets/f_f_event_98_s512_f_event_98_2bg.png"} title="初心者向け" />
        <CategoryBox url={"/tags/%E5%88%9D%E7%B4%9A%E8%80%85"} imageUrl={process.env.baseUrl + "/assets/f_f_object_151_svg_f_object_151_1bg.svg"} title="経験者向け" />
      </div>
