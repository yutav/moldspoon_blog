    ...
    <Layout>
      <div className="mt-2 md:mt-8 
       ...
       w-full lg:w-full grid grid-cols-4 lg:gap-x-16 gap-y-16 justify-items-center">
        ...
        <CategoryBox url={"/tags/%E5%88%9D%E5%BF%83%E8%80%85%E5%90%91%E3%81%91"} imageUrl={process.env.baseUrl + "/assets/f_f_event_98_s512_f_event_98_2bg.png"} title="初級者向け" />
