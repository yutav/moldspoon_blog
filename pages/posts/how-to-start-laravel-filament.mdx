...
export const meta = {
  ...
  updateDate: '2023-11-26T12:09:38.000Z',
  tags: [
    'Blog',
    '連載記事',
    '経験者向け',
...
今回は、本記事にてPHPの管理画面作成ライブラリ[Filament](https://filamentphp.com/)について、**インストールから開発環境での疎通ができるまで**をご説明してまいります。

**どうぞ最後までお付き合いください。**

### 本連載のゴール

Laravel+Filamentを使い、DockerでMySQLデータベースを立て、ローカルで開発環境が利用できるまで整える。
...
お待たせを致しますが、第2回の掲載まで少々お待ちくださいませ。
    <br />
    <br />
