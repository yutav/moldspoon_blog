...
参考記事: [【開発環境】Laravel+Filamentでらくらく管理画面を構築する方法。 第1回 ベース構築編](https://moldspoon.jp/blog/posts/how-to-start-laravel-filament)
...
RDS を立てるときは、選んだバージョンのサポート期限も一緒に確認しておくと後がラクです。

標準サポートが切れると延長サポート料が自動でかかってくるので、そこそこの金額になります。
