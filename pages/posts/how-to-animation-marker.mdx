...
export const meta = {
  ...
  updateDate: '2026-08-29T00:00:00.000Z',
  tags: [
    'Tips',
    '初級者向け',
    'プログラミング',
...
## 【2026年8月追記】宣伝: 新ツール「CSSグラデーションメーカー」を作りました！

本記事の公開から2年半、弊社のWebツール集 Spoon Tools! に**CSSグラデーションメーカー**を追加しました。

この記事で扱った`linear-gradient(transparent 60%, #FBB92F 60%)`のような値を、
色と位置をつまみで動かしながら、プレビューを見て作れます。
マーカーの太さを変えたい・色を差し替えたいというときに、数値を当てずっぽうで書き換えて
リロードする手間がなくなります。

<RichLink
  url="https://moldspoon.jp/tools/gradient"
  icon='ri-palette-line'
  title="CSSグラデーションメーカー | Spoon Tools!"
  subtitle="色と位置を指定して、linear-gradientのCSSをその場で生成できる無料Webツールです。"
  targetBlank={true}
/>
