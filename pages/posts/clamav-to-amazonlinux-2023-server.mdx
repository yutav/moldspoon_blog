...
export const meta = {
  title: 'ClamAVをEC2（Amazon Linux 2023）に導入してウィルスチェックする',
  ...
  description: 'Linux用アンチウィルスソフトClamAVをEC2上のAmazon Linux 2023に導入し、アップロードファイルをスキャンする手順を丁寧に解説します。clamscanでメモリが足りない場合のclamdscan活用法・メモリ削減設定・Laravelからの呼び出し例も追記しました。'
}
