...
const RichList: React.FC<Prop> = ({ color = "orange", title, list }) => {
  return (
    <div className="mt-5">
      {title && <div className={`font-bold bg-${color}-50 w-32 text-center px-4 py-2 rounded-tl-2xl rounded-tr-2xl border-t-4 border-l-4 border-r-4 border-${color}-300`}>{title}</div>}
