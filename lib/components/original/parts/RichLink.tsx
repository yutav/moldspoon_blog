        ...
        {moldspoonIcon ? (
          <>
            ...
            <div className="border rounded-lg p-5">
              <Image src="/assets/moldspoonblog_short.png" width="160" height="40" alt="モルドスプーンアイコン" className="mr-2 mb-2 dark:hidden block" />
              <Image src="/assets/moldspoonblog_short_white.png" width="160" height="40" alt="モルドスプーンアイコン" className="mr-2 mb-2 dark:block hidden" />
              <div>
