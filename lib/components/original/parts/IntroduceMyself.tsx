  ...
  return (
    <>
      ...
      ">
            ...
            <p className="text-xs">簡単なプロフィール:&nbsp;業界に携わって17年、iOS/Androidアプリ開発から、<br className="hidden sm:block" />データ分析業務・コンサル業務、ベンチャーから保険会社まで様々な案件を個人会社の形で請け負ってまいりました。<br className="hidden sm:block" />詳しくは<Link href="/about">こちら</Link></p>
          </div>
        </div>
      </div>
