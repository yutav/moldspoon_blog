  ...
  return (
    <>
      ...
      ">
            ...
            <p className="text-xs">簡単なプロフィール:&nbsp;MoldSpoon Inc.代表。開業から15年、業界に携わって20年。Webサイト/iOS/Androidアプリ開発から、<br className="hidden sm:block" />データ分析業務・コンサル業務、ベンチャーから保険会社まで様々な案件を個人会社の形で請け負ってまいりました。<br className="hidden sm:block" />詳しくは<Link href="/about" target="_blank">こちら</Link></p>
          </div>
        </div>
      </div>
